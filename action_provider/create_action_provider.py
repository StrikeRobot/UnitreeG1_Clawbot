...
from action_provider.action_provider_auto import AutoGraspActionProvider
...
def create_action_provider(env,args):
    ...
    elif args.action_source == "auto":
        return AutoGraspActionProvider(env=env, args_cli=args)
    else:
